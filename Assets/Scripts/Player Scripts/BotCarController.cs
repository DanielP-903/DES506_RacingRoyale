    ...
    public class BotCarController : MonoBehaviour
    {
        ...
        void decideTargetPoint()
        {
            ...
            foreach (BotPoint bt in _botPoints)
            {
                ...
                else if (Vector3.Distance(transform.position, bt.transform.position) < Vector3.Distance(transform.position, nearestPoint.position) && bt.choice == currentChoice)
                {
                    nearestPoint = bt.transform;
                }
            }
        ...
        void decideChoice()
        {
            ...
            foreach (BotPoint bt in _botPoints)
            {
                ...
                else if (Vector3.Distance(transform.position, bt.transform.position) < Vector3.Distance(transform.position, nearestPoint.position))
                {
                    nearestPoint = bt.transform;
                }
            }
        ...
        private void OnTriggerEnter(Collider other)
        {
            ...
            else if (other.gameObject.GetComponent<BotPoint>() && other.gameObject.GetComponent<BotPoint>().choices.Length > 0)
            {
